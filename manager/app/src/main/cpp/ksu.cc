...
static_assert(sizeof(ksu_provenance_create_launch_v1) == 256);
static_assert(sizeof(ksu_provenance_create_launch_result_v1) == 32);
static_assert(sizeof(ksu_provenance_activate_v1) == 32);
static_assert(sizeof(ksu_provenance_activate_result_v1) == 32);
static_assert(sizeof(ksu_provenance_close_context_v1) == 32);
static_assert(sizeof(ksu_provenance_supervisor_ready_v1) == 32);
static_assert(sizeof(ksu_provenance_current_context_v1) == 64);
static_assert(sizeof(ksu_provenance_context_status_v1) == 128);
